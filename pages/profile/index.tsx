          ...
          <div className="space-y-4 divide-y-[1px]">
            <div className="space-y-4">
              <div className="flex items-center space-x-3 pt-4">
                ...
                <div className="flex flex-col">
                  <h4 className="font-bold text-sm text-gray-700">니꼬</h4>
              ...
              <div className="text-gray-600 text-sm">
                <p>
                  ...
                  transitional period so I don&apos;t wanna kill you, I wanna
                  help you. But I can&apos;t give you this case, it don&apos;t
                  belong to me. Besides, I&apos;ve already been through too much
                  shit this morning over this case to hand it over to your dumb
                  ass.
                </p>
              </div>
            </div>
